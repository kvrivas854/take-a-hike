...
function Contact() {
    return (
      ...
      <div className="flex justify-center">
          ...
          <nav className="container flex flex-col lobster bg-green-900 box-border px-4 pt-10 pb-20 m-6 max-w-md border rounded-lg shadow-lg">
  ...
  <div className="flex justify-center">
      <input
            className="flex-col px-4 m-2 rounded-full hover:bg-green-500 focus:outline-none focus:shadow-outline"
            type="text"
          ...
          />
                ...
                <a className="flex text-white justify-center hover:underline" href="/">Existing User</a>
        </nav>
        

        
      </div>
        // <form class="flex flex-col m-10">
        //   <div class="flex flex-wrap -mx-3 mb-6">
        //     <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
        //       <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-first-name">
        //         First Name
        //       </label>
        //       <input class="form-control px-4 m-4 flex justify-center rounded-full hover:bg-green-500 focus:outline-none focus:shadow-outline" id="grid-first-name" type="text" placeholder="Jane"/>
        ...
        //         Last Name
        //       </label>
        //       <input class="form-control px-4 m-4 flex justify-center rounded-full hover:bg-green-500 focus:outline-none focus:shadow-outline" id="grid-last-name" type="text" placeholder="Doe"/>
        //     </div>
        //   </div>
        //   <div class="flex flex-wrap -mx-3 mb-6">
